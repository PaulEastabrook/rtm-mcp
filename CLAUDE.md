...
├── note_shape.py       # Write gate 2 — note-title grammar AND vocabulary gate (RTM_STRICT_NOTES; off/warn/shape/vocabulary, default VOCABULARY since v5.2.0)
