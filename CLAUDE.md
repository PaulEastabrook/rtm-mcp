...
│   └── gtd.py          # GTD domain compositions — gtd_project_plan (1 tool)
└── scripts/
...
- `tests/test_tools/test_gtd_tools.py` — gtd_project_plan via FakeMCP: by id/name, disambiguation, not-found, read-only call surface, include_completed (7 tests)
