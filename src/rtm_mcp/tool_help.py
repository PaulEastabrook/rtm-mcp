...
RECOVERY: dict[str, str] = {
    ...
    ErrorCode.NOTE_SHAPE_REJECTED: "The note title does not parse as `YYYY-MM-DD [HH:MM] — TYPE — summary`. Note the separator is an em-dash, and the TYPE token allows no underscore — the commonest two causes.",
