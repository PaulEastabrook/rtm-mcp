...
class TestParseNote:
    def test_dash_type_form_keeps_body(self):
        n = parse_note({"date": "2026-04-06", "summary": "— CONTEXT — Talked to Sam",
    ...
    def test_colon_type_form(self):
        n = parse_note({"date": "2026-04-06", "summary": "2026-04-06 OUTPUT: Delivered the draft",
...
class TestParseFile:
    def test_filed_output_path(self):
        ...
        assert f == {"n": "report.pdf", "ext": "pdf", "kind": "output",
...
class TestMapRow:
    def test_action_gets_context_comms_priority(self):
        item = map_row({"id": "c1", "name": "A",
                        "tags": ["action", "location_office", "conversation_email"],
                        "priority": "High", "completed": 0, "permalink": "u",
                        "notes": [], "files": []})
    ...
    def test_waiting_for_carries_due(self):
        item = map_row({"id": "w", "name": "W", "tags": ["waiting_for"],
                        "due": "2026-07-01", "completed": 0, "permalink": "u",
                        "notes": [], "files": []})
    ...
    def test_completed_becomes_history_row(self):
        item = map_row({"id": "d", "name": "D", "tags": ["action"], "completed": 1,
                        "completedDate": "2026-06-15", "permalink": "u",
                        "notes": [], "files": []})
        assert item["hx"] == 1
        assert item["cd"] == "2026-06-15"

    def test_nc_honest_when_notes_capped(self):
        item = map_row({"id": "c", "name": "C", "tags": ["action"], "completed": 0,
                        "permalink": "u", "noteCount": 5,
...
class TestBuildSeed:
    def _header(self):
        return {"project": {"id": "P", "life": "work", "name": "Proj",
                            "permalink": "http://rtm/P",
                            "notes": [{"date": "2026-01-01", "summary": "INCEPTION",
                                       "body": "INCEPTION"}]}}

    def _rows(self):
        return [
            {"id": "c1", "name": "First", "tags": ["action"], "priority": "NoPriority",
             "completed": 0, "due": "", "permalink": "u1", "deps": ["c2"],
             "files": [], "noteCount": 0, "notes": []},
            {"id": "c2", "name": "Second", "tags": ["action"], "priority": "NoPriority",
             "completed": 0, "due": "", "permalink": "u2", "deps": ["zzz"],
             "files": [], "noteCount": 0, "notes": []},
            {"id": "c3", "name": "Done", "tags": ["action"], "priority": "NoPriority",
             "completed": 1, "completedDate": "2026-06-10", "due": "", "permalink": "u3",
             "deps": [], "files": [], "noteCount": 0, "notes": []},
        ]
